...
BOT_MESSAGES = {
    ...
    "error.invalid_language": _(
        "nublado.bot.error.invalid_language: {language_keys}"
    ),
    ...
    "error.no_give_points_self": _("nublado.bot.error.no_give_points_self {points_name}"),
    "error.no_take_points_self": _("nublado.bot.error.no_take_points_self {points_name}"),
    "give_point": _(
